  ...
  const sites = [
    // general
    {
      google: [
        ...
        'https://www.google.com/search?q={{imdbTitle}}+{{imdbYear}}',
      ],
      googleimages: [
        'Google Images',
        'data:image/png;base64,',
        'https://www.google.com/search?q={{imdbTitle}}+{{imdbYear}}&tbm=isch',
      ],
      bing: [
        'Bing',
        ...
        'https://www.bing.com/search?q={{imdbTitle}}+{{imdbYear}}',
      ],
      ddg: [
        'DuckDuckGo',
        ...
        'https://duckduckgo.com/?q={{imdbTitle}}+{{imdbYear}}',
      ],
      qwant: [
        'Qwant',
        ...
        'https://www.qwant.com/?q={{imdbTitle}} {{imdbYear}}',
      ],
      searx: [
        'searx.me',
        ...
        'https://searx.me/?q={{imdbTitle}}+{{imdbYear}}',
      ],
      yt: [
        'YouTube',
        ...
        'https://www.youtube.com/results?search_query={{imdbTitle}}%20trailer',
      ],
      wiki_en: [
        'Wikipedia (en)',
        ...
        'https://en.wikipedia.org/w/index.php?search={{imdbTitle}}',
      ],
      wiki_de: [
        'Wikipedia (de)',
        'data:image/png;base64,',
        'https://de.wikipedia.org/w/index.php?search={{imdbTitle}}',
      ],
      wiki_fr: [
        'Wikipedia (fr)',
        'data:image/png;base64,',
        'https://fr.wikipedia.org/w/index.php?search={{imdbTitle}}',
      ],
      wiki_es: [
        'Wikipedia (es)',
        'data:image/png;base64,',
        'https://es.wikipedia.org/w/index.php?search={{imdbTitle}}',
      ],
      wiki_it: [
        'Wikipedia (it)',
        'data:image/png;base64,',
        'https://it.wikipedia.org/w/index.php?search={{imdbTitle}}',
      ],
      rt: [
        'Rotten Tomatoes',
        ...
        'https://www.rottentomatoes.com/search/?search={{imdbTitle}}',
      ...
      mc: [
        ...
        'http://www.metacritic.com/search/all/{{imdbTitle}}/results',
      ],
      am: [
        'AllMovie',
        ...
        'http://www.allmovie.com/search/movies/{{imdbTitle}}',
      ],
      bom: [
        'Box Office Mojo',
        ...
        'http://www.boxofficemojo.com/search/?q={{imdbTitle}}',
      ],
      criticker: [
        'Criticker',
        ...
        'http://www.criticker.com/?h={{imdbTitle}}&st=all&g=Go',
      ],
      letterboxd: [
        'Letterboxd',
        ...
        'https://letterboxd.com/search/films/{{imdbTitle}}/',
      ],
      thetvdb: [
        'TheTVDB.com',
        ...
        'https://thetvdb.com/?string={{imdbTitle}}&searchseriesid=&tab=listseries&function=Search',
      ],
      tmdb: [
        'TMDb',
        ...
        'https://www.themoviedb.org/search/movie?query={{imdbTitle}}',
      ],
      icheckmovies: [
        'iCheckMovies',
        ...
        'https://www.icheckmovies.com/search/movies/?query={{imdbTitle}}',
      ...
      episodecalendar: [
        ...
        'https://episodecalendar.com/en/shows?q%5Bname_cont%5D={{imdbTitle}}',
      ],
      moviemistakes: [
        'Movie Mistakes',
        ...
        'http://www.moviemistakes.com/search.php?text={{imdbTitle}}',
      ],
      imgur: [
        'Imgur',
        ...
        'https://imgur.com/search/score?q={{imdbTitle}}+{{imdbYear}}',
      ],
      wtm: [
        'What the Movie',
        ...
        'http://whatthemovie.com/search?t=movie&q={{imdbTitle}}',
      ],
      mubi: [
        'MUBI',
        ...
        'https://mubi.com/search?query={{imdbTitle}}',
      ],
      listal: [
        'Listal',
        ...
        'https://www.listal.com/search/movies/{{imdbTitle}}',
      ],
      hancinema: [
        'HanCinema',
        ...
        'http://www.hancinema.net/googlesearch.php?cx=partner-pub-1612871806153672%3A2t41l1-gajp&cof=FORID%3A10&q={{imdbTitle}}',
      ],
      kinopoisk: [
        'Kinopoisk',
        ...
        'http://www.kinopoisk.ru/index.php?level=7&from=forma&result=adv&m_act%5Bfrom%5D=forma&m_act%5Bwhat%5D=content&m_act%5Bfind%5D={{imdbTitle}}&m_act%5Byear%5D={{imdbYear}}',
      ],
      cinemaoftheworld: [
        'Cinema of the World',
        null,
        'http://worldscinema.org/?s={{imdbId}}',
      ...
      veehd: [
        ...
        'https://veehd.com/search?q={{imdbTitle}}+{{imdbYear}}',
      ],
      kinox: [
        'Kinox.to',
      ...
      filmaffinity: [
        ...
        'http://www.filmaffinity.com/en/advsearch.php?stext={{imdbTitle}}&stype[]=title&fromyear={{imdbYear}}&toyear={{imdbYear}}',
      ...
      bluraycom: [
        ...
        'http://www.blu-ray.com/movies/search.php?keyword={{imdbTitle}}&yearfrom={{imdbYear}}&yearto={{imdbYear}}&submit=Search&action=search',
      ...
      myduckisdead: [
        ...
        'http://www.myduckisdead.org/search?q=tt{{imdbId}}',
        'No posts matching the query',
      ],
      vintageclassix: [
        'Vintage Classix',
        'data:image/png;base64,',
        'http://www.vintageclassix.com/search?q=tt{{imdbId}}',
        'No posts matching the query',
      ],
      rarelust: [
        'Rarelust',
      ...
      xrel: [
        ...
        'https://www.xrel.to/search.html?xrel_search_query=tt{{imdbId}}&lang=en_US',
      ...
      srrdb: [
        ...
        'http://www.srrdb.com/browse/imdb:{{imdbId}}/1',
        '<span>0 results',
      ],
      trakttv: [
        'Trakt.tv',
        ...
        'https://trakt.tv/search/imdb?query=tt{{imdbId}}',
      ...
      graphtvmatsf: [
        ...
        'https://graph.matsf.cloud/tt{{imdbId}}',
      ],
      kereses: [
        'Keresés',
      ...
      movieparadise: [
        ...
        'http://movieparadise.org/?s={{imdbTitle}}',
      ...
      uloz: [
        ...
        'https://www.uloz.to/hledej?q={{imdbTitle}}&type=videos',
        'nebylo nic nalezeno',
      ],
      justwatch: [
        'JustWatch',
        ...
        'https://www.justwatch.com/us/search?q={{imdbTitle}}',
      ],
      ofdb: [
        'OFDb',
      ...
      startpage: [
        ...
        'https://www.startpage.com/do/dsearch?query={{imdbTitle}}',
      ],
      moviedbme: [
        'MovieDB.me',
        ...
        'https://moviedb.me/search-for-movies-tv-shows-or-people?q={{imdbTitle}}',
      ],
      rarefilm: [
        'RareFilm',
        ...
        'http://rarefilm.net/?s={{imdbId}}',
        'Sorry, but nothing matched your search criteria',
      ],
      wipfilms: ['Women in Prison Films', null, 'http://wipfilms.net/?s={{imdbId}}', 'Not Found'],
      cat3plus: [
        'Cat3Plus',
        ...
        'http://www.cat3plus.com/search?q={{imdbTitle}}',
      ],
      clubclassic: ['Club Classic', null, 'http://club-classic.com/?s={{imdbId}}', 'Not found'],
      tvtropes: [
        'TV Tropes',
        ...
        'https://tvtropes.org/pmwiki/search_result.php?q={{imdbTitle}}',
      ],
      toblek: [
        'Toblek',
        ...
        'https://toblek.com/toblekk/index.php?searchword={{imdbTitle}}&ordering=&searchphrase=all&Itemid=9&option=com_search',
      ],
      allocine: [
        'AlloCiné',
        ...
        'http://www.allocine.fr/recherche/?q={{imdbTitle}}',
        'Oups',
      ],
    },
    ...
    // tracker
    {
      kat: [
        ...
        'https://katcr.co/katsearch/page/1/{{imdbTitle}}%20{{imdbYear}}',
      ],
      pb: [
        'The Pirate Bay',
        ...
        'https://thepiratebay.org/search/{{imdbTitle}}%20{{imdbYear}}/0/99/200',
      ...
      demonoid: [
        ...
        'http://www.demonoid.to/files/?category=1&subcategory=0&language=0&quality=0&seeded=0&external=2&query={{imdbTitle}}%20{{imdbYear}}&uid=0&sort=S',
      ],
      hdbits: [
        'HDBits',
        ...
        'https://hdbits.org/browse2.php#film/dir=null&searchtype=film&actorfilm=film&search=tt{{imdbId}}',
        'Nothing here!',
        'Recover password',
      ],
      asiandvdclub: [
        ...
        'https://asiandvdclub.org/browse.php?search=tt{{imdbId}}&descr=1',
      ...
      kg: [
        ...
        'https://karagarga.in/browse.php?search={{imdbId}}&search_type=imdb',
        'No torrents found',
      ...
      ptp: [
        ...
        'https://tls.passthepopcorn.me/torrents.php?searchstr=tt{{imdbId}}',
      ...
      cinemageddon: [
        ...
        'http://cinemageddon.net/browse.php?search=tt{{imdbId}}&proj=0',
        'Nothing found!',
        'You are logged out.',
      ],
      torrentz: [
        ...
        'https://torrentz2.eu/search?f={{imdbTitle}}+{{imdbYear}}',
      ...
      '1337x': [
        ...
        'https://1337x.to/search/{{imdbTitle}}+{{imdbYear}}/1/',
      ...
      yts: [
        ...
        'https://yts.ag/browse-movies/{{imdbTitle}}/all/all/0/latest',
      ...
      torrentdownloads: [
        ...
        'https://www.torrentdownloads.me/search/?search={{imdbTitle}}+{{imdbYear}}',
      ...
      cinematik: [
        ...
        'https://cinematik.net/browse.php?cat=0&incldead=1&sort=1&type=asc&srchdtls=1&search=tt{{imdbId}}',
        'Nothing found!',
        'Not logged in!',
      ],
      torrentsmd: [
        ...
        'https://torrentsmd.com/browse.php?imdb={{imdbId}}',
      ],
      kinozal: [
        'Kinozal',
        ...
        'http://kinozal.tv/browse.php?s={{imdbTitle}}',
      ...
      hdspain: [
        ...
        'https://www.hd-spain.com/browse.php?{{imdbTitle}}',
      ],
      bithdtv: [
        'BitHDTV',
        ...
        'https://www.bit-hdtv.com/torrents.php?search={{imdbTitle}}',
        'No match!',
      ...
      awesomehd: [
        ...
        'https://awesome-hd.me/torrents.php?id=tt{{imdbId}}',
        'Your search did not match anything',
        'Keep me logged in.',
      ],
      avistaz: [
        ...
        'https://avistaz.to/movies?search=&imdb=tt{{imdbId}}',
        'No torrents found!',
      ...
      avistaztv: [
        'AvistaZTV',
        'data:image/png;base64,',
        'https://avistaz.to/tv-shows?search=&imdb=tt{{imdbId}}',
        'No torrents found!',
        'Forgot Your Password?',
      ],
      baconbits: [
        ...
        'https://baconbits.org/torrents.php?action=basic&searchstr={{imdbTitle}}+{{imdbYear}}',
      ...
      bluebirdhd: [
        ...
        'https://bluebird-hd.org/browse.php?search=&incldead=0&cat=0&dsearch={{imdbTitle}}%&stype=or',
        'Nothing found',
      ...
      broadcasthenet: [
        ...
        'https://broadcasthe.net/torrents.php?imdb=tt{{imdbId}}',
        'Error 404',
        'Lost your password?',
      ],
      cartoonchaos: [
        ...
        'http://www.cartoonchaos.org/index.php?page=torrents&search={{imdbTitle}}&category=0&options=0&active=0',
        '>Av.</td>',
      ...
      classix: [
        ...
        'http://classix-unlimited.co.uk/torrents-search.php?search={{imdbTitle}}',
        'Nothing Found',
        detectRefreshRedirect,
      ],
      dvdseed: [
        ...
        'http://www.dvdseed.eu/browse2.php?search={{imdbId}}&wheresearch=2&incldead=1&polish=0&nuke=0&rodzaj=0',
        'Nic tutaj nie ma!',
        'Nie zalogowany!',
      ],
      ethor: [
        ...
        'https://ethor.net/browse.php?stype=b&c23=1&c20=1&c42=1&c5=1&c19=1&c25=1&c6=1&c37=1&c43=1&c7=1&c9=1&advcat=0&incldead=0&includedesc=1&search={{imdbId}}',
      ...
      hdme: [
        ...
        'https://hdme.eu/browse.php?blah=2&cat=0&incldead=1&search={{imdbId}}',
        'Try again with a refined search string',
        'Note: You need cookies enabled to log in.',
      ],
      hdsky: [
      ...
      hdtorrents: [
        ...
        'http://hd-torrents.org/torrents.php?active=0&options=2&search={{imdbId}}',
        'No torrents here',
      ...
      torviet: [
        ...
        'http://torviet.com/torrents.php?search={{imdbId}}&search_area=4&search_mode=0',
        'Nothing found!',
      ...
      iloveclassics: [
        ...
        'http://www.iloveclassics.com/browse.php?incldead=1&searchin=2&search={{imdbId}}',
        'Try again with a refined search string',
        'Not logged in!',
      ],
      iptorrents: [
        ...
        'https://www.iptorrents.com/t?q=tt{{imdbId}}',
        'Nothing found!',
      ...
      myspleen: [
        ...
        'https://www.myspleen.org/browse.php?search={{imdbTitle}}&title=1&cat=0',
        'Try again with a refined search string',
        'MySpleen :: Login',
      ],
      morethantv: [
        ...
        'https://www.morethan.tv/torrents.php?searchstr={{imdbTitle}}&filter_cat%5B1%5D=1',
        'Your search did not match anything',
        'Login :: morethan.tv',
      ],
      pixelhd: [
        ...
        'https://pixelhd.me/torrents.php?groupname=&year=&tmdbover=&tmdbunder=&tmdbid=&imdbover=&imdbunder=&imdbid={{imdbId}}&order_by=time&order_way=desc&taglist=&tags_type=1&filterTorrentsButton=Filter+Torrents',
        'Your search did not match anything',
        'Login :: PiXELHD',
      ],
      revolutiontt: [
        ...
        'https://www.revolutiontt.me/browse.php?search={{imdbId}}',
        'Nothing found!',
        'Revolution :: Login',
      ],
      rutracker: [
        ...
        'https://rutracker.org/forum/tracker.php?nm={{imdbTitle}}%20{{imdbYear}}',
        'Не найдено',
      ...
      secretcinema: [
        ...
        'https://secret-cinema.pw/browse.php?search={{imdbTitle}}',
        'Try again with a refined search string',
        'Lost password',
      ],
      sdbits: [
        ...
        'http://sdbits.org/browse.php?c6=1&c3=1&c1=1&c4=1&c5=1&c2=1&m1=1&incldead=0&from=&to=&imdbgt=0&imdblt=10&uppedby=&imdb=&search={{imdbId}}',
        'Nothing found!',
        'Login :: SDBits',
      ],
      scenehd: [
        ...
        'https://scenehd.org/browse.php?imdb={{imdbId}}',
        'No torrents found',
      ...
      torrentday: [
        ...
        'https://www.torrentday.com/t?q=tt{{imdbId}}',
        'Nothing found',
        'Forgot Password',
      ],
      torrentleech: [
        ...
        'https://www.torrentleech.org/torrents/browse/index/query/{{imdbTitle}}/categories/1,8,9,10,11,12,13,14,15,29',
      ...
      uhdbits: [
        ...
        'https://uhdbits.org/torrents.php?action=advanced&groupname={{imdbId}}',
        'Your search did not match anything',
        'Login :: UHDBits',
      ],
      zooqle: [
        ...
        'https://zooqle.com/search?q=tt{{imdbId}}',
        'Sorry, ',
      ],
      yggtorrent: [
        'Yggtorrent',
        ...
        'https://yggtorrent.is/engine/search?name={{imdbTitle}}&do=search',
        'Aucun résultat',
      ],
      partis: [
        'Partis.si',
        ...
        'https://www.partis.si/torrent/show?keyword={{imdbTitle}}%20{{imdbYear}}',
      ],
      torrenthr: [
        'TorrentHR',
        ...
        'https://www.torrenthr.org/browse.php?search={{imdbTitle}}%20{{imdbYear}}&blah=0&incldead=1',
      ...
      filelist: [
        ...
        'http://filelist.ro/browse.php?search=tt{{imdbId}}&cat=0&searchin=0&sort=0',
    ...
    // subtitles
    {
      os: [
        ...
        'https://www.opensubtitles.org/en/search/sublanguageid-eng/imdbid-{{imdbId}}',
      ...
      turkcealtyazi: [
        ...
        'https://www.turkcealtyazi.org/find.php?cat=sub&find={{imdbTitle}}',
      ...
      yifysubtitles: [
        ...
        'https://www.yifysubtitles.com/search?q={{imdbTitle}}',
        'no results',
      ],
      divxsubtitles: [
        'DivX SubTitles',
      ...
      planetdp: [
        ...
        'https://www.planetdp.org/movie/search/?title=tt{{imdbId}}',
        'Sonuç bulunamadı',
      ],
      addicted: [
        'Addic7ed',
        ...
        'http://www.addic7ed.com/search.php?search={{imdbTitle}}&Submit=Search',
