...
(function () {
  ...
  const sites = [
    // general
    {
      ...
      wipfilms: ['Women in Prison Films', null, 'http://wipfilms.net/?s={{IMDB_ID}}', 'Not Found'],
      cat3plus: [
        'Cat3Plus',
      ...
      clubclassic: ['Club Classic', null, 'http://club-classic.com/?s={{IMDB_ID}}', 'Not found'],
      tvtropes: [
        'TV Tropes',
  ...
  function repl(str, encode) {
    ...
    return str
      .replace(
        ...
        encode ? encodeURIComponent(imdb_title) : imdb_title
      )
